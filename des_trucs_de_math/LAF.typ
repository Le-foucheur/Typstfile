...
$alpha mu alpha theta eta sigma.alt =$ amatès : unité, de symboles : #text(font: "Noto Sans Phoenician", str.from-unicode(0x10900)) ,tel que toute grandeurs dimentionelle vaille 3
